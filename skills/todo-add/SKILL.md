---
name: todo-add
description: Add a just-decided item to docs/todo_list.md (semantic match → update or create + Index refresh). No commit. Triggers: add to todo / register todo / todo-add / put it in next / put it in discussing / update todo.
---
