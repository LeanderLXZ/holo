---
name: commit
description: Commit the current working tree, split into logical units with safety-net checks (forbidden paths / large files). No push / force / amend. Triggers: commit / commit it / commit the current changes.
---
