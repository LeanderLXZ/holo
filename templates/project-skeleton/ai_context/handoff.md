...
## Mental Model <!-- holo:heading -->

_(none yet — delete this marker once content is added)_

## Quick Start <!-- holo:heading -->

_(none yet — delete this marker once content is added)_

## Operational Commands <!-- holo:heading -->

_(none yet — delete this marker once content is added)_

## What The User Cares About <!-- holo:heading -->

_(none yet — delete this marker once content is added)_

## After Each Milestone <!-- holo:heading -->
