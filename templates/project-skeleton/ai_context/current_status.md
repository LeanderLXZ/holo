...
# Current Status <!-- holo:heading -->

<!-- holo:section start -->
Live snapshot of where the project is **right now**. Updated whenever
the project enters a new phase, a milestone lands, or a major gap is
closed / opened. Volatile but durable — it answers "what state is the
repo in?" for a future AI session.

Do not put per-task progress here — that lives in `docs/todo_list.md`
or work-local progress files (per `skills_config.md`
§Background processes).
<!-- holo:section end -->

## Project Stage <!-- holo:heading -->

_(none yet — delete this marker once content is added)_

## What Exists <!-- holo:heading -->

_(none yet — delete this marker once content is added)_

## Current Gaps <!-- holo:heading -->

_(none yet — delete this marker once content is added)_

## Rules In Effect <!-- holo:heading -->
